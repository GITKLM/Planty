...
<?php
            ...
            ofttoCommon::generate_css('.singular .entry-header, .singular .has-post-thumbnail .entry-header, .page-header', 'padding-bottom', 'page_title_padding_bottom', '', '', (absint(get_theme_mod('page_title_padding_bottom')) -1) . 'px ');
...
<?php
            ...
            ofttoCommon::generate_css('.entry-footer > span.posted-on', 'display', 'hide_date', '', '', 'none');
